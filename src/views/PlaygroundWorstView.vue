  ...
  // Your code goes here
    ...
    methods: {
      ...
      async evaluateExercise(id, attemptFiles, previousFeedback) {
        try {
          const response = await axios.post('https://www.dcc.fc.up.pt/webpal/api/evaluateExerciseWithoutStatic', {
            id,
            attemptFiles,
            previousFeedback
          });
          ...
          var newFeedback;
          if(this.feedback === "Congratulations! Your solution passed all tests and validations."){
            newFeedback = "Correct"
          }else{
