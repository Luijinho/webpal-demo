    ...
    methods: {
      ...
      async deleteExercise(id) {
        try {
          ...
          await axios.post("https://c7a9-2001-818-daba-6200-3821-3160-2e6b-ad7c.ngrok-free.app/deleteExercise", {
            id: id
          });
      ...
      async fetchExerciseDetails(id) {
        try {
          const response = await axios.post("https://c7a9-2001-818-daba-6200-3821-3160-2e6b-ad7c.ngrok-free.app/getFullExercise", {
            id: id
          });
